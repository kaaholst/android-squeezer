...
public class JiveItem extends Item {
    private static String getString(@StringRes int resId) {
        Squeezer instance = Squeezer.getInstance();
        return instance != null ? instance.getString(resId) : "";
    }

    public static final JiveItem HOME = new JiveItem(record("home", null, getString(R.string.HOME), 1), Window.WindowStyle.HOME_MENU);
    public static final JiveItem CURRENT_PLAYLIST = new JiveItem(record("status", null, getString(R.string.menu_item_playlist), 1), Window.WindowStyle.PLAY_LIST);
    public static final JiveItem EXTRAS = new JiveItem(record("extras", "home", getString(R.string.EXTRAS), 50), Window.WindowStyle.HOME_MENU);
    public static final JiveItem SETTINGS = new JiveItem(record("settings", "home", getString(R.string.SETTINGS), 1005), Window.WindowStyle.HOME_MENU);
    public static final JiveItem ADVANCED_SETTINGS = new JiveItem(record("advancedSettings", "settings", getString(R.string.ADVANCED_SETTINGS), 105), Window.WindowStyle.TEXT_ONLY);
    public static final JiveItem ARCHIVE = new JiveItem(record("archiveNode", "home", getString(R.string.ARCHIVE_NODE), 1100), Window.WindowStyle.HOME_MENU);
    public static final JiveItem SHORTCUTS = new JiveItem(record("shortcuts", "home", getString(R.string.SHORTCUTS), 10), Window.WindowStyle.HOME_MENU);
...
//        randomPlayFolderCommand = source.readParcelable(getClass().getClassLoader());
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, jiveItem.name) && Objects.equals(text2, jiveItem.text2) && Objects.equals(icon, jiveItem.icon);
    }
